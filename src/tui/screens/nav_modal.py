...
class NavModal(ModalScreen[str | None]):
    ...
    def action_pick_home(self)          -> None: self.dismiss("home")
    def action_pick_subscriptions(self) -> None: self.dismiss("subscriptions")
    def action_pick_search(self)        -> None: self.dismiss("search")
    def action_pick_history(self)       -> None: self.dismiss("history")
    def action_pick_library(self)       -> None: self.dismiss("library")
    def action_pick_playlists(self)     -> None: self.dismiss("playlists")
    def action_pick_help(self)          -> None: self.dismiss("help")
